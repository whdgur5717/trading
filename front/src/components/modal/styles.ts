...
export const modal = tv({
  slots: {
    backdrop:
      "fixed inset-0 z-50 bg-backdrop data-[state=open]:animate-fade-in",
    content:
      "fixed inset-0 z-50 m-auto flex h-fit max-h-[calc(100dvh-2rem)] w-11/12 max-w-form flex-col overflow-hidden rounded-2xl bg-surface-modal text-ink shadow-surface inset-shadow-surface outline-none data-[state=open]:animate-fade-in",
