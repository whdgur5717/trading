...
export const select = tv({
  slots: {
    ...
    popup:
      "relative min-w-(--anchor-width) rounded-lg bg-surface-popup text-ink shadow-surface inset-shadow-surface outline-none data-open:animate-popover-in",
    ...
    scrollUpFade:
      "pointer-events-none inset-x-0 top-0 z-10 h-4 rounded-t-lg bg-linear-to-b from-surface-popup/55 to-transparent opacity-0 transition-opacity duration-150 ease-standard data-visible:opacity-100",
    scrollDownFade:
      "pointer-events-none inset-x-0 bottom-0 z-10 h-4 rounded-b-lg bg-linear-to-t from-surface-popup/55 to-transparent opacity-0 transition-opacity duration-150 ease-standard data-visible:opacity-100",
    scrollArrow:
